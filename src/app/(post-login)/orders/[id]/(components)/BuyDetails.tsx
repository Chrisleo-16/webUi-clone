...
const cancelOrder = async (orderId: string) => {
    ...
    const { data } = await AxiosInstance.post(`${baseUrl}/order/buy-orders/${orderId}/cancel`, {}, {
...
const BuyDetails = ({ order }: { order: any }) => {
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p><span className="font-semibold">Crypto Type:</span> {order.crypto_type}</p>
                ...
                <div>
                    ...
                    <p><span className="font-semibold">Min Trade Limit:</span> {order.min_limit_type} {order.min_limit} </p>
                    <p><span className="font-semibold">Max Trade Limit:</span> {order.max_limit_type} {order.max_limit}</p>
                </div>
            </div>
